...
function Caption({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <p className={cn('fluid-mt-12 fluid-copy-13 leading-[1.5] text-text-muted lg:fluid-mt-16 lg:fluid-copy-14/20', className)}>
      {children}
    </p>
  )
}
  ...
  return (
    <section id="story" className="w-full bg-surface-page">
      <div className={cn('fluid-container', 'fluid-py-96 lg:fluid-py-160')}>
        ...
        <Stage trigger="view" className="mx-auto fluid-mt-80 max-w-[980px] text-center lg:fluid-mt-140">
          <blockquote>
            ...
            <StageItem variant="liftFade" delay={0.134} className="[--hero-lift:16px]">
              <footer className="fluid-mt-24 fluid-copy-12 font-medium tracking-[0.2em] text-text-accent-ink uppercase lg:fluid-mt-32 lg:fluid-copy-12/16">
        ...
        <div className="fluid-mt-80 grid grid-cols-1 fluid-gap-48 lg:fluid-mt-140 lg:grid-cols-[minmax(0,460fr)_minmax(0,820fr)] lg:fluid-gap-x-80 lg:fluid-gap-y-0">
