 ...
 * `VIDEO-AND-MOTION-TRICKS.md` Recipe 4).
 *
 * ## The DOM contract
 *
 * ```html
 * <div data-scrub-stage>
 *   <div data-scrub-pin>                          <!-- sticky, animation.gsap.css -->
 ...
 * ```
 *
 * `animation.gsap.css` supplies the pin's `position: sticky`, the content wrapper's
