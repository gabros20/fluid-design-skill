...
/**
 * The one breakpoint every primitive in this folder agrees on: where the
 * desktop design takes over. From fluid.config.json (bands.desktop) through
 * the generated fluid.ts, so it cannot drift from the CSS.
 */
export { DESKTOP_QUERY as ENGAGE_QUERY } from '../styles/fluid/fluid'
 ...
 * `VIDEO-AND-MOTION-TRICKS.md` Recipe 1), not chosen by eye.
 */
export const MOTION = {
  /**
