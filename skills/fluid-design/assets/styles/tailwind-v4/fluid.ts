...
export const SETTINGS = {
  '--fluid-phone-base-width': { band: 'phone', default: 390, doc: "your design frame's width: at this window width 1 drawn px = 1 CSS px" },
  ...
  '--fluid-zoom-text-full': { band: null, default: 24, doc: "fluid-text at or below this drawn size zooms fully with browser zoom" },
  '--fluid-zoom-text-none': { band: null, default: 48, doc: "fluid-text at or above this drawn size keeps fitting its box instead" }
} as const
