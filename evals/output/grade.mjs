// grade.mjs — scripted assertions for evals 5 and 6 (shadcn-cn-with-fluid,
// header-stops-scaling). Point it at a skill-creator iteration folder whose
// eval-5-…/with_skill and eval-6-…/with_skill runs hold a `project/` (the
